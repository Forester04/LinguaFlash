...
import { cardsCapitals, cardsProgramming, cardsGerman, sets } from './seed_database';
...
app.get('/init', async (req, res) => {
  ...
  const seedCardsGerman = cardsGerman;
  ...
  await client.db.cards.create(seedCardsGerman);
